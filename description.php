...
if (isset($_GET['id'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        echo '<button style="padding: 10px 20px; font-size: 16px; background-color: #007bff; color: #fff; border: none; cursor: pointer; border-radius: 5px;" onclick="window.location.href=\'index.php\'">Go Back</button>';
        echo "<br>";
