...
if (isset($_GET['search'])) {
    ...
    $searchCurriculum = mysqli_real_escape_string($conn, $_GET['search']);

    // Query to fetch data from the database with pagination and search filter
    $query = "SELECT * FROM curriculum WHERE curriculum LIKE '%$searchCurriculum%' LIMIT $offset, $recordsPerPage";
    ...
    $totalRecordsQuery = "SELECT COUNT(*) as total FROM curriculum WHERE curriculum LIKE '%$searchCurriculum%'";
...
<div class="w3-content w3-margin-top" style="max-width:1400px;">
  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <div class="w3-container">
            <h5 class="w3-opacity"><b>Search Results for Curriculumt: '<?php echo $searchCurriculum; ?>'</b></h5>
            <style type="text/css">
                .clickable-box {
                    cursor: pointer;
                    padding: 1px;
            ...
            <div class="search-container">
                <form action="searchcurriculum.php" method="GET">
                    <input type="text" placeholder="Search Curriculum..." name="search" value="<?php echo $searchCurriculum; ?>">
