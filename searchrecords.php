...
if (isset($_GET['search'])) {
    ...
    $query = "SELECT * FROM files WHERE title LIKE '%$searchTitle%' LIMIT $offset, $recordsPerPage";
    ...
    $totalRecordsQuery = "SELECT COUNT(*) as total FROM files WHERE title LIKE '%$searchTitle%'";
...
<style type="text/css">
            ...
            <div style="text-align: center; overflow-x: auto;">
                ...
                <a href="records.php" class="back-link">Back</a>
            </div>
            <hr>
        </div>
    </div>
