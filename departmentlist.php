...
// Array to store unique departments
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        // Check if the department has already been displayed
        if (!in_array($row['department'], $displayedDepartments)) {
            // Store the department in the array
            $displayedDepartments[] = $row['department'];
...
$totalRecordsQuery = "SELECT COUNT(DISTINCT department) as total FROM curriculum";
...
<div class="w3-content w3-margin-top" style="max-width:1400px;">
  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-container w3-card w3-white w3-margin-bottom">
        <h2 style="color: #0c1776;" class="w3-padding-16"><i class="fa fa-building fa-fw"></i>Department List</h2>
        ...
        <div class="search-container">
            <form action="searchdepartment.php" method="GET">
                <input type="text" placeholder="Search Department..." name="search">
                    ...
                    <tbody>
                        <?php foreach ($rows as $row) : ?>
                            <tr>
                                ...
                                <td>
                                <a href="edit3.php?id=<?php echo $row['id']; ?>" class="w3-button w3-blue">
                                    ...
                                    <script>
                                        ...
                                        function deleteFile(fileId) {
                                            ...
                                            xhr.open("GET", "delete_script3.php?id=" + fileId, true);
                                            xhr.send();
                                        }
                                    </script>
                                </td>
