        ...
        <div class="container">
            <div class="row no-gutters pb-5">
                ...
                <div class="col-lg-7 px-5 pt-5">
                    ...
                    <h4>Login</h4>
                    <p class="text-muted">Access your account (Admin, Faculty, or Student)</p>
                    ...
                    <form action="" method="POST">
                        <div class="form-row">
                            <div class="col-lg-7">
                                <input type="text" class="form-control my-3 p-4" name="username" placeholder="Username" required>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-lg-7">
                                <input type="password" class="form-control my-3 p-4" name="password" placeholder="Password" required>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-lg-7">
                        ...
                        <div class="form-row">
                            <div class="col-lg-7">
                                <p>Student? <a href="student_registration.php">Register here</a></p>
