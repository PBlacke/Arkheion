...
if (isset($_GET['search'])) {
    ...
    $searchEmployeeID = mysqli_real_escape_string($conn, $_GET['search']);

    // Query to fetch data from the database with pagination and search filter
    $query = "SELECT * FROM faculty WHERE employee_id LIKE '%$searchEmployeeID%' LIMIT $offset, $recordsPerPage";
    ...
    $totalRecordsQuery = "SELECT COUNT(*) as total FROM faculty WHERE employee_id LIKE '%$searchEmployeeID%'";
        ...
        <div class="w3-row-padding">
            ...
            <div class="w3-twothird">
                ...
                <div class="w3-container w3-card w3-white w3-margin-bottom">
                    ...
                    <div class="w3-container">
                        <h5 class="w3-opacity"><b>Search Results for 'Employee ID: <?php echo $searchEmployeeID; ?>'</b></h5>
                        <style type="text/css">
                            .clickable-box {
                                cursor: pointer;
                                padding: 1px;
                        ...
                        <div class="search-container">
                            <form action="searchemployee.php" method="GET">
                                <input type="text" placeholder="Search Employee ID..." name="search" value="<?php echo $searchEmployeeID; ?>">
                        ...
                        <div style="text-align: center; overflow-x: auto;">
                            ...
                            <a href="facultylist2.php" class="back-link">Back</a>
                        </div>
                        <hr>
                    </div>
                </div>
