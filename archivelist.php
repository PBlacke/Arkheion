  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        <h2 style="color: #0c1776;" class="w3-text-grey w3-padding-16"><i class="fa fa-suitcase fa-fw w3-margin-right w3-xxlarge w3-text-#0c1776"></i>Archive List</h2>
                    ...
                    <tbody>
                        <?php foreach ($rows as $row) : ?>
                            <tr>
                                ...
                                <td>
                                <a href="edit2.php?id=<?php echo $row['id']; ?>" class="w3-button w3-blue">
