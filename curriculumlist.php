...
// Query to fetch data from the database with pagination, excluding rows with empty curriculum
$query = "SELECT * FROM curriculum WHERE curriculum IS NOT NULL AND curriculum != '' LIMIT $offset, $recordsPerPage";
...
// Query to get the total number of records for pagination, excluding rows with empty curriculum
$totalRecordsQuery = "SELECT COUNT(*) as total FROM curriculum WHERE curriculum IS NOT NULL AND curriculum != ''";
...
<div class="w3-content w3-margin-top" style="max-width:1400px;">
  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-container w3-card w3-white w3-margin-bottom">
        <h2 style="color: #0c1776;" class="w3-padding-16"><i class="fa fa-book fa-fw"></i>Curriculum List</h2>
        <div class="w3-container">
            <h5 class="w3-opacity"><b>Here you can add Curriculum to the system</b></h5>
        <style type="text/css">
            .clickable-box {
                cursor: pointer;
                padding: 1px;
        ...
        <div class="clickable-box" onclick="location.href='add4.php';">
            <h5><b>Add New</b></h5>
        </div>

        <!-- Add the search bar with search icon to the right -->
        <div class="search-container">
            <form action="searchcurriculum.php" method="GET">
                <input type="text" placeholder="Search Curriculum..." name="search">
                    ...
                    <tbody>
                        <?php foreach ($rows as $row) : ?>
                            <tr>
                                ...
                                <td>
                                <a href="edit4.php?id=<?php echo $row['id']; ?>" class="w3-button w3-blue">
                                    ...
                                    <script>
                                        ...
                                        function deleteFile(fileId) {
                                            ...
                                            xhr.open("GET", "delete_script4.php?id=" + fileId, true);
                                            xhr.send();
                                        }
                                    </script>
                                </td>
